...
mod tests {
    ...
    #[test]
    fn test_echanger_elements_tableau() {
        let mut t = Tableau {
            elements:vec![1,2,3],
            taille: 3,
            capacite: 10,
        };
        t.echanger_elements_tableau(0, 2);
        assert_eq!(t.elements, [3,2,1]);
    }

    #[test]
    fn test_somme_tableau() {
        let mut t = Tableau {
            elements:vec![1,2,3],
            taille: 3,
            capacite: 10,
        ...
        let mut t3 = Tableau {
            elements:vec![2,4,6,4],
            taille: 4,
            capacite: 11,
        };

        //assert_eq!(somme_tableau(T, T2), T3);
